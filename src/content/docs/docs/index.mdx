...
- **Components** — a growing set under [`ghcr.io/actpkg`](https://github.com/orgs/actpkg/packages): `sqlite`, `http-client`, `crypto`, `encoding`, `filesystem`, `openwallet`, `python-eval`, `js-eval`, `act-http-bridge`, `mcp-bridge`, `openapi-bridge`, `random`, `time`.
