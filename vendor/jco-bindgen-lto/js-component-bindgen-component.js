...
function generateTypes(arg0, arg1) {
  ...
  switch (variant6.tag) {
    case 'source': {
      ...
      dataView(memory0).setUint32(ptr0 + 16, len3, true);
      dataView(memory0).setUint32(ptr0 + 12, ptr3, true);
      break;
    }
    case 'binary': {
      const e = variant6.val;
  ...
  if (variant8 === null || variant8=== undefined) {
    ...
    dataView(memory0).setUint32(ptr0 + 28, len7, true);
    dataView(memory0).setUint32(ptr0 + 24, ptr7, true);
  }
  var variant9 = v2_2;
  ...
  if (variant16 === null || variant16=== undefined) {
    ...
    for (let i = 0; i < vec15.length; i++) {
      ...
      var encodeRes = _utf8AllocateAndEncode(tuple12_0, realloc1, memory0);
      var ptr13= encodeRes.ptr;
      var len13 = encodeRes.len;
      
      dataView(memory0).setUint32(base + 4, len13, true);
      dataView(memory0).setUint32(base + 0, ptr13, true);
      
      var encodeRes = _utf8AllocateAndEncode(tuple12_1, realloc1, memory0);
    ...
    dataView(memory0).setUint32(ptr0 + 44, len15, true);
    dataView(memory0).setUint32(ptr0 + 40, result15, true);
  }
  var variant20 = v2_5;
  if (variant20 === null || variant20=== undefined) {
    dataView(memory0).setInt8(ptr0 + 48, 0, true);
    ...
    switch (variant19.tag) {
      case 'list': {
        ...
        dataView(memory0).setUint32(ptr0 + 60, len18, true);
        dataView(memory0).setUint32(ptr0 + 56, result18, true);
        break;
      }
      case 'all': {
        dataView(memory0).setInt8(ptr0 + 52, 1, true);
    ...
    switch (variant27.tag) {
      ...
      case 'jspi': {
        ...
        for (let i = 0; i < vec24.length; i++) {
          const e = vec24[i];
          const base = result24 + i * 8;
          var encodeRes = _utf8AllocateAndEncode(e, realloc1, memory0);
          var ptr23= encodeRes.ptr;
          var len23 = encodeRes.len;
          
          dataView(memory0).setUint32(base + 4, len23, true);
          dataView(memory0).setUint32(base + 0, ptr23, true);
        }
        dataView(memory0).setUint32(ptr0 + 80, len24, true);
        dataView(memory0).setUint32(ptr0 + 76, result24, true);
        var vec26 = v22_1;
        var len26 = vec26.length;
        var result26 = realloc1(0, 0, 4, len26 * 8);
        for (let i = 0; i < vec26.length; i++) {
          const e = vec26[i];
          const base = result26 + i * 8;
          var encodeRes = _utf8AllocateAndEncode(e, realloc1, memory0);
        ...
        dataView(memory0).setUint32(ptr0 + 88, len26, true);
        dataView(memory0).setUint32(ptr0 + 84, result26, true);
        break;
      }
      default: {
